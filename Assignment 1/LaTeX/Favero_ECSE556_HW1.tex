...
\newpage
\appendix
\section{Regression on Non-Normalized Feature Data}\label{app:A}
...
\begin{table}[H]
    ...
    \begin{tabular}{|c|c|c|c|c|}
        ...
        Outer Fold & Alpha & Mean Squared Error & Spearman Correlation & p-value \\
        \hline
        1 & 0.3 & 2.459 & 0.28 & $2.67 \times 10^{-5}$ \\
